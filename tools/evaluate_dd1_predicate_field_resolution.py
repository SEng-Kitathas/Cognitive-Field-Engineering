...
def main():
 ...
 a.out.mkdir(parents=True);verify_lock(root,a.lock);c=loadj(a.contract);host=loadj(a.host_lock);run=loadj(a.run_manifest)
 if run['arm']!=a.arm or run['seed']!=a.seed:raise SystemExit('RUN_BINDING_FAIL')
 import torch
