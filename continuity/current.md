...
## Verified
- v1.2 complete 12/12; composition basis not supported.
- v1.3 PID `23156` alive; 5/12 sealed = 2/6 complete pairs.
...
- Curator decomposition != learner decomposition remains candidate law.
- Dose/horizon parked behind v1.3.
- Microseed applicability unverified.

## Blockers
None.

## Resume point
Keep PID `23156` only; finish seed3103 WINDOW_SEPARATED, publish full pair, then continue seeds3104..3106 unchanged.
